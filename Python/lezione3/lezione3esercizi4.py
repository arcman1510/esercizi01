...
plist = ["margherita", "provola e speck", "cicoria e salsiccia"]

for element in plist:
    txt = f"Mi mangerò una bella " + element + " stasera"
    print(txt)

print("Comincerei con una margherita, \n poi una provola e speck \n e in fine cicoria e salsiccia. \n Se potessi, mi sposerei la pizza :D ")
